...
namespace ATMOS_14
{
    ...
    public sealed partial class App : Application
    {
        ...
        public static Microsoft.WindowsAzure.MobileServices.MobileServiceClient atmosClient = new Microsoft.WindowsAzure.MobileServices.MobileServiceClient(
        "https://atmos.azure-mobile.net/",
        "GWSiCGrxlNsXBgbnuLBgITrByqYwdJ90");
#endif

#if WINDOWS_PHONE_APP
        private TransitionCollection transitions;
#endif
        public static bool themeB = true;
        /// <summary>
        ...
        public App()
        {
            ...
            if (this.RequestedTheme == ApplicationTheme.Light) themeB = false;
            else themeB = true;
...
#if WINDOWS_PHONE_APP
            // http://go.microsoft.com/fwlink/?LinkId=290986&clcid=0x409
            ATMOS_14.atmosPush.UploadChannel();
#endif
        }
